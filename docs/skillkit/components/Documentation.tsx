    ...
    content: (
      <div className="space-y-4">
        ...
        <ul className="list-disc list-inside space-y-2 text-zinc-400">
          <li><span className="text-white">AI Instruction Generation (Primer)</span> - Analyze your codebase and generate customized instruction files for all 45 agents</li>
...
skillkit primer --all-agents   # Generate for all 45 agents
